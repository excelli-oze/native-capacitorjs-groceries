...
<div class="px-2 bg-blue-100 md:px-20">
				...
				{:else}
					<div>
						...
						<form>
							...
							{/if}
							<button
								class="px-4 py-2 mt-4 font-bold bg-green-500 rounded text-green-950 hover:bg-blue-600 active:bg-green-700 focus:outline-none focus:shadow-outline"
								type="button"
