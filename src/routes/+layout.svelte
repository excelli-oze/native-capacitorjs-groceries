...
<body class={` selection:bg-green-950 selection:text-green-100 font-semibold  `}>
	<div class="fixed w-[100%]">
		<nav class="bg-blue-600 flex pr-4">
			<div
			...
			>
				<a href="./" class="text-xl font-bold"> GROCERIES </a>
			</div>
		</nav>

		<nav class="bg-blue-400 sticky top-0 z-20">
												...
												{:else}
													<div class="flex flex-col w-full">
														...
														<div class=" ">
															...
															<button
																class="px-4 py-2 my-2 w-full text-xl bg-blue-400 text-green-950 hover:bg-green-700 hover:text-green-50 active:bg-blue-600 active:outline-none focus:outline-none focus:ring-2 focus:ring-green-600"
																on:click={() => {
																	cartUI = false;
																	orderUI = true;
																}}
										...
										>
											<div class=" text-green-50">
												...
												<form class="flex flex-col gap-2 px-4 pt-2 my-4 bg-green-700">
													<div class="flex flex-col">
														...
														<input
															...
															class="px-4 py-2 mb-2 w-full text-md bg-blue-100 border focus:outline-none focus:ring-2 focus:ring-green-800 text-green-950"
														/>
													</div>
													<div class="flex flex-col">
														...
														<textarea
															bind:value={address}
															placeholder="Address"
															class="px-4 py-2 mb-2 w-full h-32 text-md bg-blue-100 border focus:outline-none focus:ring-2 focus:ring-green-800 text-green-950"
														/>
													</div>
													<div class="flex flex-col">
												...
												<button
													...
													class="py-2 mt-2 mb-8 w-full text-xl bg-blue-400 text-green-950 hover:bg-green-700 hover:text-green-50 active:bg-blue-600 active:outline-none focus:outline-none focus:ring-2 focus:ring-green-600"
												>
													Order
												</button>
											</div>
