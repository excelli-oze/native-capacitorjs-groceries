...
class RealtimeClient {
  ...
  connect() {
    ...
    __vitePreload(async () => {
      const { default: WS } = await import("./browser.CoMIO10A.js").then((n) => n.b);
      return { default: WS };
...
const LocalNotifications = registerPlugin("LocalNotifications", {
  web: () => __vitePreload(() => import("./web.CvTZSwEO.js"), true ? [] : void 0, import.meta.url).then((m) => new m.LocalNotificationsWeb())
});
const Toast = registerPlugin("Toast", {
  web: () => __vitePreload(() => import("./web.DnuqRe_r.js"), true ? [] : void 0, import.meta.url).then((m) => new m.ToastWeb())
});
...
const ActionSheet = registerPlugin("ActionSheet", {
  web: () => __vitePreload(() => import("./web.Bai6zLWa.js"), true ? [] : void 0, import.meta.url).then((m) => new m.ActionSheetWeb())
});
...
supabase.auth.getSession().then(({ data }) => {
  var _a;
  userSession.set((_a = data.session) == null ? void 0 : _a.user);
});
